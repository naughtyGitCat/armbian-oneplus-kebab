...
//
// Vendored from Xo666/mainline-instantnoodle (6.16.7) for the OnePlus 8T
...
static int samsung_amb655x_on(struct samsung_amb655x *amb655x)
{
	...
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xd5, 0x24, 0x9e, 0x9e, 0x00, 0x20);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xf0, 0xa5, 0xa5);

	/* OSC Select */
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xf0, 0x5a, 0x5a);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xfc, 0x5a, 0x5a);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xb0, 0x16);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xd1, 0x22);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xd6, 0x11);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xfc, 0xa5, 0xa5);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xf0, 0xa5, 0xa5);

	/* TE ON */
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xf0, 0x5a, 0x5a);
	mipi_dsi_dcs_write_seq_multi(&ctx, MIPI_DCS_SET_TEAR_ON, MIPI_DSI_DCS_TEAR_MODE_VBLANK);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xf0, 0xa5, 0xa5);

	/* TSP Setting */
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xf0, 0x5a, 0x5a);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xdf, 0x83, 0x00, 0x10);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xb0, 0x01);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xe6, 0x01);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xf0, 0xa5, 0xa5);
	...
	/* FD Setting */
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xf0, 0x5a, 0x5a);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xd5, 0x8d);
	...
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xe9,
				      0x11, 0x75, 0xa6, 0x75,
				      0xa3, 0x4b, 0x17, 0xac,
				      0x4b, 0x17, 0xac, 0x00,
				      0x19, 0x19);
	...
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xb7, 0x01);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xb0, 0x05);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xb7, 0x13);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xb0, 0x01);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xb7, 0x4c);
	mipi_dsi_dcs_write_seq_multi(&ctx, 0xf0, 0xa5, 0xa5);
...
static int samsung_amb655x_unprepare(struct drm_panel *panel)
{
	...
	ret = regulator_bulk_disable(ARRAY_SIZE(amb655x->supplies),
				     amb655x->supplies);
	if (ret) {
				     ...
				     struct drm_connector *connector)
{
	...
	mode = drm_mode_duplicate(connector->dev, &samsung_amb655x_60_mode);
	if (!mode)
		return -ENOMEM;
